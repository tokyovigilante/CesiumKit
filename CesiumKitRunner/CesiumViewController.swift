...
class CesiumViewController: GLKViewController {
    ...
    private func setupContext () {
        ...
        //Murrumbeena
        //globe.scene.camera.lookAt(Cartesian3.fromDegrees(longitude: 145.075, latitude: -37.892, height: 10), offsetCartesian: nil, offsetHPR: HeadingPitchRange(heading: 0.0, pitch: Math.toRadians(0), range: 1000))
        //Wellington
